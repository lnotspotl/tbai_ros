...
SegmentedPlanesTerrainModelRos::SegmentedPlanesTerrainModelRos(ros::NodeHandle &nodehandle)
    ...
    terrainSubscriber_ = nodehandle.subscribe("/convex_plane_decomposition_ros/planar_terrain", 1,
                                              &SegmentedPlanesTerrainModelRos::callback, this);
    distanceFieldPublisher_ = nodehandle.advertise<sensor_msgs::PointCloud2>(
        "/convex_plane_decomposition_ros/signed_distance_field", 1, true);
}
...
void SegmentedPlanesTerrainModelRos::callback(const convex_plane_decomposition_msgs::PlanarTerrain::ConstPtr &msg) {
    ...
    if (sdfPtr != nullptr) {
        ...
        grid_map::GridMapRosConverter::toPointCloud(sdf, *pointCloud2MsgPtr, 1,
...
std::pair<Eigen::Vector3d, Eigen::Vector3d> SegmentedPlanesTerrainModelRos::getSignedDistanceRange(
