...
class GridmapReferenceTrajectoryGenerator : public ReferenceTrajectoryGenerator {
   public:
    ...
    GridmapReferenceTrajectoryGenerator(
        ...
        std::shared_ptr<tbai::mpc::quadruped_arm::KinematicsModelBase<ocs2::scalar_t>> kinematicsPtr, ocs2::scalar_t trajdt = 0.1,
   ...
   private:
    ...
    void publishLocalTerrain(const tbai::mpc::quadruped_arm::TerrainPlane &terrainPlane);
