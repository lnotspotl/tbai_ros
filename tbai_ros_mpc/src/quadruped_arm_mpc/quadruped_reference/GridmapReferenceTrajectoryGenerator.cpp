...
#include <tbai_mpc/quadruped_arm_mpc/quadruped_commands/TerrainAdaptation.h>
...
GridmapReferenceTrajectoryGenerator::GridmapReferenceTrajectoryGenerator(
    ...
    std::shared_ptr<tbai::mpc::quadruped_arm::KinematicsModelBase<ocs2::scalar_t>> kinematicsPtr, ocs2::scalar_t trajdt,
...
ocs2::TargetTrajectories GridmapReferenceTrajectoryGenerator::generateReferenceTrajectory(
    ...
    for (size_t i = 0; i < N; ++i) {
        ...
        auto Rt = tbai::mpc::quadruped_arm::rotationMatrixOriginToBase(baseReferenceTrajectory.eulerXyz[i]);
