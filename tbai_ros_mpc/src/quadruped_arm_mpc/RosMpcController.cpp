...
RosMpcController::RosMpcController(const std::string &robotName,
    ...
    visualizerPtr_ = std::make_unique<tbai::mpc::quadruped_arm::QuadrupedVisualizer>(quadrupedInterfacePtr_->getKinematicModel(),
...
std::unique_ptr<ocs2::MPC_BASE> RosMpcController::createMpcInterface() {
    ...
    auto mpcPtr = tbai::mpc::quadruped_arm::getSqpMpc(*quadrupedInterfacePtr_, mpcSettings, sqpSettings);
